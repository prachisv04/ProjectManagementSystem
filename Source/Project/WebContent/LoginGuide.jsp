	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="LogGuide.jsp">
					...
					<div class="wrap-input100 validate-input m-b-18" data-validate = "Password is required">
						...
						<input class="input100" type="password" name="pass" id="pass" placeholder="Enter password" onkeyup="passvalidate();">
						<span class="focus-input100"></span>
					</div>
					<div>
